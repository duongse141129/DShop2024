    ...
    public class ChatController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var customers = await (from u in _context.Users
                                   ...
                                   join m in _context.Messages on u.Id equals m.UserId into userMessages
                                   from latestMessage in userMessages
                                               .OrderByDescending(m => m.Timestamp)
                                               .Take(1)
                                               .DefaultIfEmpty()
                                   orderby latestMessage.Timestamp descending
                                   select new CustomerAndMessageViewModel
                                   {
                                       UserId = u.Id,
                                       UserName = u.UserName,
                                       Avatar = u.Avatar,
